...
type Props = TouchableOpacityProps &{
    ...
    // variant: define a cor do icone e do texto(variação de estilos do texto dentro de uma mesma variável)
    // por padr o a cor   "primary" (verde) mas pode ser alterado para "secondary" (cinza)
